module Tonal
  ...
  INTERVALS = [
    ...
    {name: "A6", semitones: 1, degree: 6, displacements: [ 1,  1,  2,  1,  1,  2,  2]},
    # 7th
    {name: "d7", semitones: 9, degree: 7, displacements: [-2, -1, -1, -2, -1, -1, -1]},
    {name: "m7", semitones: 1, degree: 7, displacements: [-1,  0,  0, -1,  0,  0,  0]},
    {name: "M7", semitones: 1, degree: 7, displacements: [ 0,  1,  1,  0,  1,  1,  1]},
    {name: "A7", semitones: 1, degree: 7, displacements: [ 1,  2,  2,  1,  2,  2,  2]},
  ].inject({}) {|h, definition|
